eagle.define('partner.autocomplete.core', function (require) {
'use strict';
...
return {
    ...
    autocomplete: function (value) {
        ...
        var eaglePromise = this._getEagleSuggestions(value, isVAT).then(function (suggestions){
        ...
        var concatResults = function () {
            ...
            return def.resolve(eagleSuggestions);
        };

        this._whenAll([eaglePromise, clearbitPromise]).then(concatResults, concatResults);
