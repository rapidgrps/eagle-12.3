...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("Eagle Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("Eagle Error"),
...
function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("Eagle Session Expired"), data: {message: _t("Your Eagle session expired. Please refresh the current web page.")}});
        }
    }
}
...
eagle.define('web.crash_manager', function (require) {
"use strict";
