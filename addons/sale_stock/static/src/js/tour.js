...
if (_.contains(eagle._modules, 'sale_management')) {
    deps.push('sale.product_configurator_tour');
    deps.push('sale.product_configurator_pricelist_tour');
}

eagle.define("sale_stock.tour", deps, function (require) {
    "use strict";

    var tour = require('web_tour.tour');

    if (_.has(eagle.__DEBUG__.services, 'sale.product_configurator_tour')) {
    ...
    if (_.has(eagle.__DEBUG__.services, 'sale.product_configurator_pricelist_tour')) {
