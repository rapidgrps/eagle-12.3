...
QUnit.test('messaging menu widget: rendering with EagleBot has a request', function (assert) {
    assert.expect(5);
...
QUnit.test('messaging menu widget: rendering without EagleBot has a request (denied)', function (assert) {
    assert.expect(3);
...
QUnit.test('messaging menu widget: rendering without EagleBot has a request (accepted)', function (assert) {
    assert.expect(3);
