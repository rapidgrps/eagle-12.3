define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // EAGLE: allow access for override
    this.table = table;   // EAGLE: allow access for override
    this.typing = typing; // EAGLE: allow access for override
    this.bullet = bullet; // EAGLE: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // EAGLE: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // EAGLE: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // EAGLE: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // EAGLE: addition
        $(anchor).css(linkInfo.style || {}); // EAGLE: addition
        if (isNewWindow) {
