eagle.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.eagle[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.eagle[callback + '_editor']) {
                window.top.eagle[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.eagle[callback + '_downup']) {
                    window.top.eagle[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
eagle.define('web_editor.IframeRoot', function (require) {
'use strict';
